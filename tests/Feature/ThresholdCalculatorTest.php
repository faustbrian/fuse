...
use Carbon\Carbon;
use Cline\Fuse\ThresholdCalculator;
...
it('supports overnight peak windows before midnight', function () {
...
it('supports overnight peak windows after midnight', function () {
